...
wp_enqueue_script('dbp-invoices');
dbp_header(array(
...
<script>
	jQuery("#<?php echo $data["field"]?>").addClass("<?php echo $data["class"]?>").focus(function(){ jQuery(this).removeClass("ui-state-error"); jQuery("#message").slideUp("slow"); });
	jQuery("#message").show();
</script>
<?php endif?>