...
wp_enqueue_script('dbp-products');
wp_enqueue_script('jquery-image-selecter');
$heading_args = array(
	"heading"	=> "Productos",
	"page"	=> "dbp_products",
	"id"	=> "icon-products-page",
	"url"	=> admin_url('post-new.php'),
	"new-text"	=> "Nuevo producto"
	);
...
<script>
	jQuery("<?php echo $field?>").addClass("<?php echo $class?>").focus(function(){ jQuery(this).removeClass("ui-state-error"); jQuery("#message").slideUp("slow"); });
	jQuery("#message").show();
</script>
<?php endif?>