...
function dbp_init()
{
	...
	wp_register_style( 'jqui', plugin_dir_url( __FILE__ ) . 'skins/smoothness/ui-min.css');
	...
	wp_register_script( 'dbp-clients', plugin_dir_url( __FILE__ ) . 'js/dbp-clients.js');
	wp_register_script( 'dbp-invoices', plugin_dir_url( __FILE__ ) . 'js/dbp-invoices.js');
	wp_register_script( 'dbp-products', plugin_dir_url( __FILE__ ) . 'js/dbp-products.js');
	
	load_plugin_textdomain('dbp-lang', false, 'dyn-bussiness-panel/languages');
} 
